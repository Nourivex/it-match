-- Active booth configuration. Keep this version aligned with the bundled fallback.
insert into public.game_config (key, value, version, active)
values (
  'booth',
  $$
  {
    "questionVersion": "2026.09.15",
    "config": { "communityCtaUrl": "", "resultIdleSeconds": 90, "activeIdleSeconds": 180 },
    "buildComponents": [
...
set value = excluded.value, active = excluded.active, updated_at = now();

insert into public.game_questions (id, round, question, options, metadata, version, active) values
(
  'instinct-outage', 'instinct',
  'Website kampus tiba-tiba tidak bisa dibuka. Apa yang paling membuatmu penasaran?',
  $$[
  ...
  '{"eyebrow":"Campus signal 01"}'::jsonb, '2026.09.15', true
),
(
  'instinct-crowd', 'instinct',
  'Aplikasi acara kampus mendadak dipakai ribuan orang. Bagian mana yang paling ingin kamu pegang?',
  $$[
  ...
  '{"eyebrow":"Campus signal 02"}'::jsonb, '2026.09.15', true
),
(
  'instinct-admin', 'instinct',
  'Proses administrasi kampus terasa berulang dan memakan waktu. Apa yang ingin kamu lakukan dulu?',
  $$[
  ...
  '{"eyebrow":"Campus signal 03"}'::jsonb, '2026.09.15', true
),
(
  'crisis-server', 'crisis',
  'Website kampus tidak bisa diakses. Tindakan pertama mana yang paling menarik untuk kamu lakukan?',
  $$[
  ...
  '{"eyebrow":"Server outage","headline":"SERVER DOWN","icon":"alert"}'::jsonb, '2026.09.15', true
),
(
  'crisis-login', 'crisis',
  'Ada pola login yang tidak biasa pada akun kampus. Apa yang ingin kamu cek lebih dulu?',
  $$[
  ...
  '{"eyebrow":"Security signal","headline":"SUSPICIOUS LOGIN","icon":"shield"}'::jsonb, '2026.09.15', true
),
(
  'crisis-ui', 'crisis',
  'Formulir pendaftaran terlihat rusak di beberapa layar. Dari mana kamu ingin mulai?',
  $$[
  ...
  '{"eyebrow":"Experience issue","headline":"BROKEN UI","icon":"layout"}'::jsonb, '2026.09.15', true
),
(
  'crisis-database', 'crisis',
  'Pencarian data mahasiswa makin lambat. Investigasi mana yang paling membuatmu penasaran?',
  $$[
  ...
  '{"eyebrow":"Performance issue","headline":"SLOW DATABASE","icon":"database"}'::jsonb, '2026.09.15', true
),
(
  'crisis-dataset', 'crisis',
  'Data kegiatan mahasiswa datang dari banyak sumber dan tidak rapi. Apa yang ingin kamu lakukan dulu?',
  $$[
  ...
  '{"eyebrow":"Data issue","headline":"MESSY DATASET","icon":"chart"}'::jsonb, '2026.09.15', true
),
(
  'decision-website', 'decisions',
  'Kamu punya satu hari untuk meningkatkan website kampus. Fokusmu ke mana?',
  $$[
  ...
  '{"eyebrow":"Quick decision 01"}'::jsonb, '2026.09.15', true
),
(
  'decision-data', 'decisions',
  'Kamu menerima dataset yang berantakan. Apa yang paling ingin kamu temukan?',
  $$[
  ...
  '{"eyebrow":"Quick decision 02"}'::jsonb, '2026.09.15', true
),
(
  'decision-login', 'decisions',
  'Satu login mencurigakan muncul. Detail mana yang pertama menarik perhatianmu?',
  $$[
  ...
  '{"eyebrow":"Quick decision 03"}'::jsonb, '2026.09.15', true
)
